...
Eigen::Matrix<double, 24, 1> get_f(state_ikfom &s, const input_ikfom &in) {
    ...
    vect3 omega;
    in.gyro.boxminus(omega, s.bg); // omega = omega - s.bg
...
Eigen::Matrix<double, 24, 23> df_dx(state_ikfom &s, const input_ikfom &in) {
    ...
    vect3 acc_;
    in.acc.boxminus(acc_, s.ba); // acc_ -= s.ba;
    vect3 omega;
    in.gyro.boxminus(omega, s.bg); // omega -= s.bg;
    // hat(v): 0, -v[2], v[1], v[2], 0, -v[0], -v[1], v[0], 0;
